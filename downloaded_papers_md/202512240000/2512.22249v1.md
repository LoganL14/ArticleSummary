...
| Method  Acc  ↑  NMI  ↑  SSC [93]  0.3137  0.3858  OSC [5]  0.4393  0.5931  TSC(M) [6]  0.4653  0.6935  LTS [7]  0.4924  0.6213  DSAE [70]  0.5136  0.5100  VSDA [9]  0.5804  0.7397  CDMS(M) [8]  0.6044  0.7891  SIBMSC [16]  0.3886  0.4744  FSMSC [18]  0.4702  0.3970  BTMSC [17]  0.4297  0.4862  ARLRR [19]  0.5010  0.5270  DCTMSC [20]  0.4723  0.4866  DCMVC [69]  0.5395  0.8049  TVSH  0.8048  0.8690  Method  Acc  ↑  NMI  ↑  SSC [93]  0.3817  0.4758  OSC [5]  0.4327  0.5589  TSC(K) [6]  0.5473  0.7691  LTS [7]  0.5466  0.6547  DSAE [70]  0.5898  0.6309  VSDA [9]  0.5606  0.7770  CDMS(K) [8]  0.6536  0.8251  SIBMSC [16]  0.3639  0.4309  FSMSC [18]  0.3914  0.3226  BTMSC [17]  0.2397  0.2249  ARLRR [19]  0.5125  0.5099  DCTMSC [20]  0.4885  0.5372  DCMVC [69]  0.5792  0.8286  TVSH  0.8372  0.8438  Method  Acc  ↑  NMI  ↑  SSC [93]  0.4389  0.4998  OSC [5]  0.5846  0.6877  TSC(K) [6]  0.5213  0.7216  LTS [7]  0.6724  0.7435  DSAE [70]  0.7323  0.6717  VSDA [9]  0.6203  0.8226  CDMS(K) [8]  0.6547  0.8267  SIBMSC [16]  0.4477  0.4894  FSMSC [18]  0.4787  0.4213  BTMSC [17]  0.4162  0.4051  ARLRR [19]  0.5148  0.5121  DCTMSC [20]  0.5569  0.5293  DCMVC [69]  0.5371  0.7746  TVSH  0.8723  0.8488  Method  Acc  ↑  NMI  ↑  SSC [93]  0.4576  0.6009  OSC [5]  0.5216  0.7047  TSC(K) [6]  0.5931  0.7971  LTS [7]  0.5674  0.6959  DSAE [70]  0.6120  0.6627  VSDA [9]  0.6287  0.7992  CDMS(K) [8]  0.6465  0.8601  SIBMSC [16]  0.4127  0.5435  FSMSC [18]  0.3914  0.3226  BTMSC [17]  0.3638  0.4382  ARLRR [19]  0.5436  0.5371  DCTMSC [20]  0.5592  0.5906  DCMVC [69]  0.6030  0.8326  TVSH  0.8745  0.9316   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| (a) Results on Keck dataset  Method  Pr  ↑  ARI  ↑  SSC [93]  0.3511  0.2446  OSC [5]  0.3767  0.2743  TSC(M) [6]  0.4214  0.3457  LTS [7]  0.4457  0.3052  DSAE [70]  0.4195  0.3418  VSDA [9]  0.4311  0.3529  CDMS(M) [8]  0.5828  0.5174  SIBMSC [16]  0.3773  0.2292  FSMSC [18]  0.4702  0.3970  BTMSC [17]  0.3592  0.2418  ARLRR [19]  0.5772  0.5046  DCTMSC [20]  0.3753  0.2741  DCMVC [69]  0.3908  0.3136  TVSH  0.7559  0.7214  (b) Results on MAD dataset  Method  Pr  ↑  ARI  ↑  SSC [93]  0.3151  0.1994  OSC [5]  0.4024  0.2403  TSC(K) [6]  0.5116  0.3724  LTS [7]  0.4673  0.3426  DSAE [70]  0.5492  0.3891  VSDA [9]  0.5667  0.3780  CDMS(K) [8]  0.5761  0.4128  SIBMSC [16]  0.3227  0.1478  FSMSC [18]  0.3914  0.3226  BTMSC [17]  0.2882  0.1809  ARLRR [19]  0.5426  0.4072  DCTMSC [20]  0.4508  0.2917  DCMVC [69]  0.5487  0.3623  TVSH  0.7043  0.6973  (c) Results on UT dataset  Method  Pr  ↑  ARI  ↑  SSC [93]  0.5426  0.3772  OSC [5]  0.5426  0.3966  TSC(K) [6]  0.5864  0.4217  LTS [7]  0.5774  0.4457  DSAE [70]  0.6189  0.4895  VSDA [9]  0.6334  0.5202  CDMS(K) [8]  0.6466  0.5539  SIBMSC [16]  0.4972  0.3193  FSMSC [18]  0.5242  0.5047  BTMSC [17]  0.5360  0.3667  ARLRR [19]  0.6054  0.5213  DCTMSC [20]  0.5635  0.4383  DCMVC [69]  0.6131  0.4688  TVSH  0.7477  0.7153  (d) Results on Weiz dataset  Method  Pr  ↑  ARI  ↑  SSC [93]  0.4469  0.3620  OSC [5]  0.5126  0.4422  TSC(K) [6]  0.5667  0.5324  LTS [7]  0.5991  0.5724  DSAE [70]  0.6233  0.5406  VSDA [9]  0.6180  0.5378  CDMS(K) [8]  0.6316  0.5561  SIBMSC [16]  0.3643  0.2909  FSMSC [18]  0.3914  0.3226  BTMSC [17]  0.4397  0.3491  ARLRR [19]  0.6211  0.5146  DCTMSC [20]  0.5502  0.4914  DCMVC [69]  0.6045  0.5280  TVSH  0.9012  0.8867   |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

TABLE III: The comparison of run-time (minute) on the Keck dataset.

| Method  SSC  OSC  TSC  LTS  DSAE  VSDA  CDMS  Time  1.1  2.5  1.9  3.3  4.5  4.4  5.1  Method  SIBMSC  FSMSC  BTMSC  ARLRR  DCTMSC  DCMVC  TVSH  Time  5.8  4.3  4.4  5.3  4.7  4.8  4.2   |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Keck  MAD  UT  Acc  NMI  Acc  NMI  Acc  NMI  TVSH (w/o joint op-  timization)  0.7423  0.8429  0.7848  0.8322  0.8254  0.8371  TVSH (w/o temporal  model)  0.7152  0.7428  0.7211  0.7546  0.6714  0.6211  TVSH  0.8048  0.8690  0.8372  0.8438  0.8723  0.8488   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| Method  Parameters (B)  Runtime/question (s)  Acc (%)  GPT-o1  175  1.84  88.27  DeepSeek-v3-2-exp  67  0.95  85.71  Claude-Sonnet-4-5-20250929  70  0.72  86.88  Gemini-2.0-Flash-exp  120  0.36  87.47  Grok-4  314  3.69  84.17  Qwen3-235B-a22b  235  2.20  87.52   |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|

TABLE VI: Accuracy of different prompts for TVS Learning on Weiz dataset.

| Prompt  a)  b)  c)  d)  e)  f)  Acc  88.27  89.14  88.89  89.58  89.77  89.94   |
|---------------------------------------------------------------------------------|
